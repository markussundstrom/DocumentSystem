...
namespace DocumentSystem.Controllers
{
    ...
    [ApiController]
    public class OldDocumentsController : ControllerBase
    {
        private readonly DocumentSystemContext _context;

        public DocumentsController(DocumentSystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Document>> PostDocument(Document document)
        {
          if (_context.Documents == null)
          {
              return Problem("Entity set 'DocumentSystemContext.Documents'  is null.");
          }
